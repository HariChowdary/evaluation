...
import com.infoplustech.smartscrutinization.evaluation.Eval_MarksEntryActivity;
import com.infoplustech.smartscrutinization.utils.SSConstants;

import java.util.ArrayList;
import java.util.HashMap;

public class Scrutiny_MarksEntryActivity extends Activity {
...
int TotalCount=0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(R.id.title_id)).setText("Chief Examiner ID");
		...
		if (_cursor != null && _cursor.getCount() > 0) {
			if(_cursor.moveToFirst()){
				do {
					sub_code = _cursor.getString(_cursor.getColumnIndex(SSConstants.SUBJECT_CODE));
				//	setDatatoView(i++, _cursor.getString(_cursor.getColumnIndex(SSConstants.ANS_BOOK_BARCODE)));
					dbMap.put(_cursor.getString(_cursor.getColumnIndex(SSConstants.ANS_BOOK_BARCODE))
					,_cursor.getString(_cursor.getColumnIndex(SSConstants.GRAND_TOTAL_MARK)));
	...
	private void setTotalScriptCount(boolean first){
		final Dialog dialog = new Dialog(Scrutiny_MarksEntryActivity.this);
		...
		((TextView) dialog.findViewById(R.id.limit)).setText("Script Count Limit "+dbMap.size());
		image.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!count.isEmpty()) {
					try {
						...
						if (c > 0) {
							...
							dialog.dismiss();
								...
								text.setText("");
								Toast.makeText(Scrutiny_MarksEntryActivity.this, "Please Verify Bundle Script Count", Toast.LENGTH_SHORT).show();
							}
						}else{
							text.setText("");
							Toast.makeText(Scrutiny_MarksEntryActivity.this, "Please Enter valid Script Count", Toast.LENGTH_SHORT).show();
						}
					} catch (Exception e) {
						e.printStackTrace();
						text.setText("");
					...
					text.setText("");
					Toast.makeText(Scrutiny_MarksEntryActivity.this, "Please Enter Script Count", Toast.LENGTH_SHORT).show();
				}
		...
		myAlertDialog.setPositiveButton("YES",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface Dialog, int arg1) {
						Intent intent=new Intent(Scrutiny_MarksEntryActivity.this, Scrutiny_MarksSummryActivity.class);
	...
	private void setDatatoView(int no){
		...
		switch (no){case 1: ((TableRow) findViewById(R.id.tr_1)).setVisibility(View.VISIBLE); ((EditText) findViewById(R.id.sn_1)).setEnabled(true); break;
	...
	String rm=""+((EditText) findViewById(remarks_id)).getText().toString().trim();
			if (!sn.isEmpty()) {
					...
					if(dbMap.containsKey(sn)) {
						if (!snArray.contains(sn)) {
							...
							if (ss.isEmpty()) {
								...
								Toast.makeText(Scrutiny_MarksEntryActivity.this, "Please Enter Valid Script Number", Toast.LENGTH_SHORT).show();
								return false;
							}
						} else {
							((EditText) findViewById(sn_id)).setText("");
							((EditText) findViewById(sn_id)).requestFocus();
							Toast.makeText(Scrutiny_MarksEntryActivity.this, "Duplicate Script Number not allowed", Toast.LENGTH_SHORT).show();
							return false;
						}
					} else {
						((EditText) findViewById(sn_id)).setText("");
						((EditText) findViewById(sn_id)).requestFocus();
						Toast.makeText(Scrutiny_MarksEntryActivity.this, sn+" Script Number not valid for this Bundle", Toast.LENGTH_SHORT).show();
						return false;
					}
				} else {
					((EditText) findViewById(sn_id)).setText("");
				...
				((EditText) findViewById(sn_id)).setText("");
				((EditText) findViewById(sn_id)).requestFocus();
				Toast.makeText(Scrutiny_MarksEntryActivity.this, "Please Enter Script Number", Toast.LENGTH_SHORT).show();
				return false;
			}
	...
	try{
		...
		if(marks>=0&&marks<=100) {
			...
			Toast.makeText(Scrutiny_MarksEntryActivity.this, "Please Enter Valid Marks", Toast.LENGTH_SHORT).show();
			return false;
		}
	}catch (Exception e){
		e.printStackTrace();
		...
		((EditText) findViewById(tm_id)).setText("");
		((EditText) findViewById(tm_id)).requestFocus();
	Toast.makeText(Scrutiny_MarksEntryActivity.this,"Please Enter Marks", Toast.LENGTH_SHORT).show();
	return false;
}
		}else{
			return true;
	...
	private void setInvisibilView(int no) {
		...
		switch (no) {
			case 1:
				((TableRow) findViewById(R.id.tr_1)).setVisibility(View.GONE);
				break;
			case 2:
				((TableRow) findViewById(R.id.tr_2)).setVisibility(View.GONE);
				break;
			case 3:
				((TableRow) findViewById(R.id.tr_3)).setVisibility(View.GONE);
				break;
			case 4:
				((TableRow) findViewById(R.id.tr_4)).setVisibility(View.GONE);
				break;
			case 5:
				((TableRow) findViewById(R.id.tr_5)).setVisibility(View.GONE);
				break;
			case 6:
				((TableRow) findViewById(R.id.tr_6)).setVisibility(View.GONE);
				break;
			case 7:
				((TableRow) findViewById(R.id.tr_7)).setVisibility(View.GONE);
				break;
			case 8:
				((TableRow) findViewById(R.id.tr_8)).setVisibility(View.GONE);
				break;
			case 9:
				((TableRow) findViewById(R.id.tr_9)).setVisibility(View.GONE);
				break;
			case 10:
				((TableRow) findViewById(R.id.tr_10)).setVisibility(View.GONE);
				break;
			case 11:
				((TableRow) findViewById(R.id.tr_11)).setVisibility(View.GONE);
				break;
			case 12:
				((TableRow) findViewById(R.id.tr_12)).setVisibility(View.GONE);
				break;
			case 13:
				((TableRow) findViewById(R.id.tr_13)).setVisibility(View.GONE);
				break;
			case 14:
				((TableRow) findViewById(R.id.tr_14)).setVisibility(View.GONE);
				break;
			case 15:
				((TableRow) findViewById(R.id.tr_15)).setVisibility(View.GONE);
				break;
			case 16:
				((TableRow) findViewById(R.id.tr_16)).setVisibility(View.GONE);
				break;
			case 17:
				((TableRow) findViewById(R.id.tr_17)).setVisibility(View.GONE);
				break;
			case 18:
				((TableRow) findViewById(R.id.tr_18)).setVisibility(View.GONE);
				break;
			case 19:
				((TableRow) findViewById(R.id.tr_19)).setVisibility(View.GONE);
				break;
			case 20:
				((TableRow) findViewById(R.id.tr_20)).setVisibility(View.GONE);
				break;
			case 21:
				((TableRow) findViewById(R.id.tr_21)).setVisibility(View.GONE);
				break;
			case 22:
				((TableRow) findViewById(R.id.tr_22)).setVisibility(View.GONE);
				break;
			case 23:
				((TableRow) findViewById(R.id.tr_23)).setVisibility(View.GONE);
				break;
			case 24:
				((TableRow) findViewById(R.id.tr_24)).setVisibility(View.GONE);
				break;
			case 25:
				((TableRow) findViewById(R.id.tr_25)).setVisibility(View.GONE);
				break;
			case 26:
				((TableRow) findViewById(R.id.tr_26)).setVisibility(View.GONE);
				break;
			case 27:
				((TableRow) findViewById(R.id.tr_27)).setVisibility(View.GONE);
				break;
			case 28:
				((TableRow) findViewById(R.id.tr_28)).setVisibility(View.GONE);
				break;
			case 29:
				((TableRow) findViewById(R.id.tr_29)).setVisibility(View.GONE);
				break;
			case 30:
				((TableRow) findViewById(R.id.tr_30)).setVisibility(View.GONE);
				break;
			case 31:
				((TableRow) findViewById(R.id.tr_31)).setVisibility(View.GONE);
				break;
			case 32:
				((TableRow) findViewById(R.id.tr_32)).setVisibility(View.GONE);
				break;
			case 33:
				((TableRow) findViewById(R.id.tr_33)).setVisibility(View.GONE);
				break;
			case 34:
				((TableRow) findViewById(R.id.tr_34)).setVisibility(View.GONE);
				break;
			case 35:
				((TableRow) findViewById(R.id.tr_35)).setVisibility(View.GONE);
				break;
			case 36:
				((TableRow) findViewById(R.id.tr_36)).setVisibility(View.GONE);
				break;
			case 37:
				((TableRow) findViewById(R.id.tr_37)).setVisibility(View.GONE);
				break;
			case 38:
				((TableRow) findViewById(R.id.tr_38)).setVisibility(View.GONE);
				break;
			case 39:
				((TableRow) findViewById(R.id.tr_39)).setVisibility(View.GONE);
				break;
			case 40:
				((TableRow) findViewById(R.id.tr_40)).setVisibility(View.GONE);
				break;
			case 41:
				((TableRow) findViewById(R.id.tr_41)).setVisibility(View.GONE);
				break;
			case 42:
				((TableRow) findViewById(R.id.tr_42)).setVisibility(View.GONE);
				break;
			case 43:
				((TableRow) findViewById(R.id.tr_43)).setVisibility(View.GONE);
				break;
			case 44:
				((TableRow) findViewById(R.id.tr_44)).setVisibility(View.GONE);
				break;
			case 45:
				((TableRow) findViewById(R.id.tr_45)).setVisibility(View.GONE);
				break;
			case 46:
				((TableRow) findViewById(R.id.tr_46)).setVisibility(View.GONE);
				break;
			case 47:
				((TableRow) findViewById(R.id.tr_47)).setVisibility(View.GONE);
				break;
			case 48:
				((TableRow) findViewById(R.id.tr_48)).setVisibility(View.GONE);
				break;
			case 49:
				((TableRow) findViewById(R.id.tr_49)).setVisibility(View.GONE);
				break;
			case 50:
				((TableRow) findViewById(R.id.tr_50)).setVisibility(View.GONE);
				break;
		}
	}
